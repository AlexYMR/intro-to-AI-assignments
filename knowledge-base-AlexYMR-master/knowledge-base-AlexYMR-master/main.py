...
class KBTest(unittest.TestCase):
    ...
    def test6(self):
        self.KB.kb_assert(read.parse_input("fact: (isa Animal Thing)"))
        self.KB.kb_assert(read.parse_input("fact: (isa Mammal Animal)"))
        self.KB.kb_assert(read.parse_input("fact: (isa Dog Mammal)"))
    ...
    def test7(self):
        ...
        self.KB.kb_assert(read.parse_input("fact: (isa Mammal Animal)"))
        self.KB.kb_assert(read.parse_input("fact: (isa Dog Mammal)"))
        ask1 = read.parse_input("fact: (isa Dog Thing)")
        print(' Asking if', ask1)
        answer = self.KB.kb_ask(ask1)
        self.assertFalse(answer)
